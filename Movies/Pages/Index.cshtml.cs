...
namespace Movies.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public void OnPost()
        {
            ...
            if (search != null)
            {
                Movies = Movies.Where(movie => movie.Title.Contains(search, StringComparison.InvariantCultureIgnoreCase)&&  mpaa.Contains(movie.MPAA_Rating));
                    //MovieDatabase.Search(Movies, search);
            }
